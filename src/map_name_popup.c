...
{
    [MAPSEC_TOSA_PORT] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SOUTH_TOSA_RESERVE] = MAPPOPUP_THEME_WOOD,
...
{
    [MAPSEC_TOSA_PORT] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_SOUTH_TOSA_RESERVE] = MAPPOPUP_THEME_BW_DEFAULT,
