...
{
    [MAPSEC_TOSA_PORT] = {MAP_GROUP(MAP_TOSA_PORT), MAP_NUM(MAP_TOSA_PORT), HEAL_LOCATION_TOSA_PORT_MAYS_HOUSE},
    ...
    [MAPSEC_SOUTH_TOSA_RESERVE] = {MAP_GROUP(MAP_SOUTHTOSARESERVE), MAP_NUM(MAP_SOUTHTOSARESERVE), HEAL_LOCATION_NONE},
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_TOSA_PORT:
        return (gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_TOSA_PORT_MAYS_HOUSE : HEAL_LOCATION_TOSA_PORT_MAYS_HOUSE);
    case MAPSEC_EVER_GRANDE_CITY:
